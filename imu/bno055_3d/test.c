...
// 更新姿態角
void updateAngles() {
    xAngle += gyroX * deltaTime;
    yAngle += gyroY * deltaTime;
    zAngle += gyroZ * deltaTime;
...
void timer(int value) {
    //readIMU();
    bno055_read_imu_data();
    updateAngles();
    glutPostRedisplay();
    glutTimerFunc(10, timer, 0); // 每 10 毫秒更新一次
}
...
//    }
    ...
    glutCreateWindow("IMU-Based 3D Attitude Visualization");
